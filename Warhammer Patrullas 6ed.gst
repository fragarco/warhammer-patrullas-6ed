...
<gameSystem id="33ac-caba-e4b6-0c32" name="Warhammer Fantasy 6ed" revision="1" battleScribeVersion="2.03" authorName="Javier García &quot;Dwayne Hicks&quot;" authorContact="cabohicks1986@gmail.com" authorUrl="http://www.leyendasenminiatura.com/" xmlns="http://www.battlescribe.net/schema/gameSystemSchema">
  <readme>Este proyecto se ha creado a partir del increible trabajo realizado por la gente de Leyendas en Minuatura y sus Data Files creados para Warhammer Fantasy 6ª edición más MdN.

leyendasenminiatura@gmail.com

Esta versión simplemente:
- Elimina todo lo que no estuviera en 6 ed.
- Trata de añadir el modo Warhammer Patrullas (Warbands)</readme>
  <costTypes>
  ...
  <forceEntries>
    ...
    <forceEntry id="c8d8-6feb-de16-2f2f" name="4000-4999" hidden="false">
      <categoryLinks>
        <categoryLink id="42fd-0388-d6ee-a269" name="Comandante" hidden="false" targetId="9769-7233-6405-675e" primary="false">
          <constraints>
            <constraint field="selections" scope="parent" value="3.0" percentValue="false" shared="false" includeChildSelections="false" includeChildForces="false" id="1ba9-d6f8-19d8-2292" type="max"/>
          </constraints>
        </categoryLink>
        <categoryLink id="2730-810b-6c6e-97c0" name="Héroe" hidden="false" targetId="c647-4209-4e6c-206a" primary="false">
          <constraints>
            <constraint field="selections" scope="parent" value="8.0" percentValue="false" shared="false" includeChildSelections="false" includeChildForces="false" id="b110-ba6e-981b-ccc3" type="max"/>
          </constraints>
        </categoryLink>
        <categoryLink id="aa36-2d7f-69fa-8163" name="Unidad básica" hidden="false" targetId="ba68-224b-3224-a908" primary="false">
          <constraints>
            <constraint field="selections" scope="parent" value="5.0" percentValue="false" shared="false" includeChildSelections="false" includeChildForces="false" id="9eb7-589d-27f9-44ee" type="min"/>
          </constraints>
        </categoryLink>
        <categoryLink id="5dbc-a0b5-d517-bd83" name="Unidad especial" hidden="false" targetId="102e-012c-5785-3354" primary="false">
          <constraints>
            <constraint field="selections" scope="parent" value="6.0" percentValue="false" shared="false" includeChildSelections="false" includeChildForces="false" id="f64f-433e-b101-1aac" type="max"/>
          </constraints>
        </categoryLink>
        <categoryLink id="44e8-9c6c-31b9-4a7b" name="Unidad singular" hidden="false" targetId="184a-30ec-bf7c-b603" primary="false">
          <constraints>
            <constraint field="selections" scope="parent" value="4.0" percentValue="false" shared="false" includeChildSelections="false" includeChildForces="false" id="3603-a1aa-001c-1282" type="max"/>
          </constraints>
        </categoryLink>
    ...
    <forceEntry id="332b-d853-aebf-0295" name="2000-2999" hidden="false">
      <categoryLinks>
        <categoryLink id="acb5-2500-8496-d528" name="Comandante" hidden="false" targetId="9769-7233-6405-675e" primary="false">
          <constraints>
            <constraint field="selections" scope="parent" value="1.0" percentValue="false" shared="false" includeChildSelections="false" includeChildForces="false" id="d4b4-2a0d-0459-e5a1" type="max"/>
          </constraints>
        </categoryLink>
        <categoryLink id="51f7-bec6-a9fe-0ec5" name="Héroe" hidden="false" targetId="c647-4209-4e6c-206a" primary="false">
          <constraints>
            <constraint field="selections" scope="parent" value="4.0" percentValue="false" shared="false" includeChildSelections="false" includeChildForces="false" id="a49b-d3c2-4105-2e59" type="max"/>
          </constraints>
        </categoryLink>
        <categoryLink id="e1ee-afab-f9eb-8c13" name="Unidad básica" hidden="false" targetId="ba68-224b-3224-a908" primary="false">
          <constraints>
            <constraint field="selections" scope="parent" value="3.0" percentValue="false" shared="false" includeChildSelections="false" includeChildForces="false" id="1f9f-9f2b-a61b-676a" type="min"/>
          </constraints>
        </categoryLink>
        <categoryLink id="9ab7-1492-cbed-2d66" name="Unidad especial" hidden="false" targetId="102e-012c-5785-3354" primary="false">
          <constraints>
            <constraint field="selections" scope="parent" value="4.0" percentValue="false" shared="false" includeChildSelections="false" includeChildForces="false" id="bad7-f103-12d0-fddf" type="max"/>
          </constraints>
        </categoryLink>
        <categoryLink id="c750-62d2-d5e7-cbf8" name="Unidad singular" hidden="false" targetId="184a-30ec-bf7c-b603" primary="false">
          <constraints>
            <constraint field="selections" scope="parent" value="2.0" percentValue="false" shared="false" includeChildSelections="false" includeChildForces="false" id="e81b-dbd4-31cf-7c08" type="max"/>
          </constraints>
        </categoryLink>
    ...
    <forceEntry id="82a5-5766-86ca-d92f" name="3000-3999" hidden="false">
      <categoryLinks>
        <categoryLink id="075a-0626-e9ba-84c6" name="Comandante" hidden="false" targetId="9769-7233-6405-675e" primary="false">
          <constraints>
            <constraint field="selections" scope="parent" value="2.0" percentValue="false" shared="false" includeChildSelections="false" includeChildForces="false" id="5e2b-36db-5524-16cd" type="max"/>
          </constraints>
        </categoryLink>
        <categoryLink id="32c5-d62b-7dfd-fdd4" name="Héroe" hidden="false" targetId="c647-4209-4e6c-206a" primary="false">
          <constraints>
            <constraint field="selections" scope="parent" value="6.0" percentValue="false" shared="false" includeChildSelections="false" includeChildForces="false" id="f8f5-e0dd-a902-0f2a" type="max"/>
          </constraints>
        </categoryLink>
        <categoryLink id="dbb2-d74e-4e6a-902b" name="Unidad básica" hidden="false" targetId="ba68-224b-3224-a908" primary="false">
          <constraints>
            <constraint field="selections" scope="parent" value="4.0" percentValue="false" shared="false" includeChildSelections="false" includeChildForces="false" id="1fb0-1e7a-e44c-2c88" type="min"/>
          </constraints>
        </categoryLink>
        <categoryLink id="5bd0-6808-f2d0-94e6" name="Unidad especial" hidden="false" targetId="102e-012c-5785-3354" primary="false">
          <constraints>
            <constraint field="selections" scope="parent" value="5.0" percentValue="false" shared="false" includeChildSelections="false" includeChildForces="false" id="a7f6-8e79-1180-bb54" type="max"/>
          </constraints>
        </categoryLink>
        <categoryLink id="b4ec-91c4-93fe-aa84" name="Unidad singular" hidden="false" targetId="184a-30ec-bf7c-b603" primary="false">
          <constraints>
            <constraint field="selections" scope="parent" value="3.0" percentValue="false" shared="false" includeChildSelections="false" includeChildForces="false" id="44e9-6c5b-e656-aced" type="max"/>
          </constraints>
        </categoryLink>
    ...
    <forceEntry id="7423-8eda-673b-97db" name="Patrulla 200-500" hidden="false">
      <comment>Para jugar el modo especial de Warhammer Patrullas (Warbands)</comment>
      <categoryLinks>
        <categoryLink id="9f0b-5c60-2174-6143" name="Comandante" hidden="false" targetId="9769-7233-6405-675e" primary="false">
          <constraints>
            <constraint field="selections" scope="parent" value="0.0" percentValue="false" shared="true" includeChildSelections="false" includeChildForces="false" id="6acd-e0e6-bce3-6066" type="max"/>
          </constraints>
        </categoryLink>
        <categoryLink id="e20b-137e-14bf-b397" name="Héroe" hidden="false" targetId="c647-4209-4e6c-206a" primary="false">
          <constraints>
            <constraint field="selections" scope="parent" value="2.0" percentValue="false" shared="true" includeChildSelections="false" includeChildForces="false" id="c03f-5c2a-fd34-7bfe" type="max"/>
            <constraint field="53ea-00f4-9046-81ff" scope="parent" value="150.0" percentValue="false" shared="true" includeChildSelections="false" includeChildForces="false" id="2300-45e6-2156-cf63" type="max"/>
          </constraints>
        </categoryLink>
        <categoryLink id="d689-4aba-4e37-a198" name="Unidad básica" hidden="false" targetId="ba68-224b-3224-a908" primary="false">
          <constraints>
            <constraint field="selections" scope="parent" value="2.0" percentValue="false" shared="true" includeChildSelections="false" includeChildForces="false" id="5083-2fe2-dced-9853" type="min"/>
          </constraints>
        </categoryLink>
        <categoryLink id="5bb1-219e-e445-fd2c" name="Unidad especial" hidden="false" targetId="102e-012c-5785-3354" primary="false">
          <constraints>
            <constraint field="selections" scope="parent" value="2.0" percentValue="false" shared="true" includeChildSelections="false" includeChildForces="false" id="64e7-601b-3945-e65f" type="max"/>
          </constraints>
        </categoryLink>
        <categoryLink id="fc53-28fa-3e77-b2ff" name="Unidad singular" hidden="false" targetId="184a-30ec-bf7c-b603" primary="false">
          <constraints>
            <constraint field="selections" scope="parent" value="1.0" percentValue="false" shared="true" includeChildSelections="false" includeChildForces="false" id="cc26-09ab-f34c-9aea" type="max"/>
          </constraints>
        </categoryLink>
      </categoryLinks>
    </forceEntry>
